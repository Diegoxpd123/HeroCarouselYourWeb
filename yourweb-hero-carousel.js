...
(function () {
  ...
  var STYLE = [
    ...
    "  :host{--yw-min-height:300px;--yw-ghost-size:clamp(62px,24vw,126px);--yw-title-size:clamp(36px,12vw,62px);}",
    ...
    "  :host{--yw-min-height:280px;--yw-ghost-size:clamp(52px,24vw,96px);--yw-title-size:clamp(32px,12vw,50px);--yw-center-height-mobile:38%;--yw-side-height-mobile:13%;--yw-back-height-mobile:10%;--yw-center-bottom-mobile:30%;}",
    ...
    "  :host{--yw-min-height:260px;--yw-ghost-size:clamp(46px,23vw,78px);--yw-title-size:clamp(28px,12vw,42px);--yw-center-height-mobile:34%;--yw-side-height-mobile:11%;--yw-center-bottom-mobile:32%;--yw-left-pos-mobile:16%;--yw-right-pos-mobile:84%;}",
    ...
    "  :host{--yw-min-height:240px;--yw-title-size:30px;--yw-ghost-size:58px;--yw-center-height-mobile:32%;--yw-center-bottom-mobile:33%;}",
