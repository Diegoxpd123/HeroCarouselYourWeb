...
(function () {
  ...
  var STYLE = [
    ...
    "  --yw-title-size:clamp(34px,6.4vw,68px);",
    "  --yw-center-height:74%;",
    "  --yw-center-height-mobile:56%;",
    "  --yw-side-height:24%;",
    "  --yw-side-height-mobile:19%;",
    "  --yw-back-height:22%;",
    "  --yw-back-height-mobile:16%;",
    "  --yw-center-scale:1.12;",
    "  --yw-center-scale-mobile:1;",
    "  --yw-side-scale:1;",
    "  --yw-back-scale:1;",
    "  --yw-center-bottom:2%;",
    "  --yw-center-bottom-mobile:17%;",
    "  --yw-side-bottom:12%;",
    "  --yw-side-bottom-mobile:30%;",
    "  --yw-back-bottom:12%;",
    "  --yw-back-bottom-mobile:30%;",
    "  --yw-left-pos:30%;",
    "  --yw-right-pos:70%;",
    ...
    "h1{margin:0;font-family:var(--yw-display);font-size:var(--yw-title-size);font-weight:900;letter-spacing:-.03em;line-height:.98;text-transform:uppercase;max-width:12ch;}",
    ...
    "  :host{--yw-min-height:300px;--yw-ghost-size:clamp(48px,16vw,88px);--yw-title-size:clamp(30px,9vw,48px);}",
    ...
    "  :host{--yw-min-height:280px;--yw-ghost-size:clamp(42px,15vw,72px);--yw-title-size:clamp(28px,8.5vw,42px);--yw-center-height-mobile:52%;--yw-side-height-mobile:17%;--yw-back-height-mobile:14%;--yw-center-bottom-mobile:19%;}",
    ...
    "  :host{--yw-min-height:260px;--yw-ghost-size:clamp(36px,14vw,58px);--yw-title-size:clamp(24px,8.2vw,36px);--yw-center-height-mobile:48%;--yw-side-height-mobile:15%;--yw-back-height-mobile:12%;--yw-center-bottom-mobile:22%;--yw-left-pos-mobile:16%;--yw-right-pos-mobile:84%;}",
    ...
    "  :host{--yw-min-height:240px;--yw-title-size:26px;--yw-ghost-size:46px;--yw-center-height-mobile:44%;--yw-side-height-mobile:14%;--yw-back-height-mobile:11%;--yw-center-bottom-mobile:24%;}",
    ...
    "  :host{--yw-min-height:430px;--yw-title-size:clamp(34px,8vw,58px);--yw-ghost-size:clamp(80px,20vw,170px);--yw-center-height:68%;--yw-center-height-mobile:54%;--yw-side-height-mobile:18%;--yw-back-height-mobile:14%;}",
    "  .content{top:60%;}",
    "  .body{display:none;}",
    "}",
  ].join("");
