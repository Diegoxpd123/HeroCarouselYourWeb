...
(function () {
  ...
  var STYLE = [
    ...
    ".ghost{position:absolute;inset:0 0 auto;top:8%;z-index:2;display:flex;justify-content:center;align-items:center;white-space:nowrap;color:rgba(255,255,255,.54);font-family:var(--yw-display);font-size:var(--yw-ghost-size);letter-spacing:-.05em;line-height:.82;text-transform:uppercase;pointer-events:none;user-select:none;}",
    ...
    ".content{position:absolute;left:clamp(18px,5vw,62px);top:50%;transform:translateY(-42%);z-index:20;width:min(44%,520px);max-width:calc(100% - 36px);text-shadow:none;}",
    ...
    "h1{margin:0;font-family:var(--yw-display);font-size:var(--yw-title-size);letter-spacing:-.055em;line-height:.82;text-transform:uppercase;max-width:10ch;}",
    ...
    "  :host{--yw-title-size:clamp(42px,7vw,72px);--yw-ghost-size:clamp(96px,23vw,230px);--yw-center-height:66%;--yw-center-scale:1.06;--yw-stage-center:72%;--yw-left-pos:55%;--yw-right-pos:91%;}",
