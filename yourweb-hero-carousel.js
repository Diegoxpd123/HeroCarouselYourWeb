...
(function () {
  ...
  var STYLE = [
    ...
    "  --yw-center-height-desktop:82%;",
    "  --yw-center-height-tablet:70%;",
    "  --yw-center-height-mobile:78%;",
    "  --yw-center-height:var(--yw-center-height-desktop);",
    "  --yw-side-height-desktop:28%;",
    "  --yw-side-height-tablet:24%;",
    "  --yw-side-height-mobile:26%;",
    "  --yw-side-height:var(--yw-side-height-desktop);",
    "  --yw-back-height-desktop:22%;",
    "  --yw-back-height-tablet:20%;",
    "  --yw-back-height-mobile:22%;",
    "  --yw-back-height:var(--yw-back-height-desktop);",
    "  --yw-center-scale-desktop:1.32;",
    "  --yw-center-scale-tablet:1.18;",
  ...
  class YourWebHeroCarousel extends HTMLElement {
    ...
    _applyVars() {
      var map = {
        ...
        "ghost-size-desktop": "--yw-ghost-size-desktop",
        "ghost-size-tablet": "--yw-ghost-size-tablet",
        "ghost-size-mobile": "--yw-ghost-size-mobile",
        "title-size": "--yw-title-size",
        "center-height": "--yw-center-height",
        "center-height-desktop": "--yw-center-height-desktop",
        "center-height-tablet": "--yw-center-height-tablet",
        "center-height-mobile": "--yw-center-height-mobile",
        "side-height": "--yw-side-height",
        "side-height-desktop": "--yw-side-height-desktop",
        "side-height-tablet": "--yw-side-height-tablet",
        "side-height-mobile": "--yw-side-height-mobile",
        "back-height": "--yw-back-height",
        "back-height-desktop": "--yw-back-height-desktop",
        "back-height-tablet": "--yw-back-height-tablet",
        "back-height-mobile": "--yw-back-height-mobile",
        "center-scale": "--yw-center-scale",
        "center-scale-desktop": "--yw-center-scale-desktop",
        "center-scale-tablet": "--yw-center-scale-tablet",
