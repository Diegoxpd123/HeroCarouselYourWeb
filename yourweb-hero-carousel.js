...
(function () {
  ...
  var STYLE = [
    ...
    "  :host{--yw-min-height:280px;--yw-ghost-size:clamp(42px,15vw,72px);--yw-title-size:clamp(28px,8.5vw,42px);--yw-center-height-mobile:38%;--yw-side-height-mobile:13%;--yw-back-height-mobile:10%;--yw-center-bottom-mobile:30%;}",
    ...
    "  :host{--yw-min-height:260px;--yw-ghost-size:clamp(36px,14vw,58px);--yw-title-size:clamp(24px,8.2vw,36px);--yw-center-height-mobile:34%;--yw-side-height-mobile:11%;--yw-center-bottom-mobile:32%;--yw-left-pos-mobile:16%;--yw-right-pos-mobile:84%;}",
    ...
    "  :host{--yw-min-height:240px;--yw-title-size:26px;--yw-ghost-size:46px;--yw-center-height-mobile:32%;--yw-center-bottom-mobile:33%;}",
